    ...
    <section class="content">
      <div class="row">
        <div class="col-lg-12">
          ...
          <center>
            <font color="blue">
              <h1>Pemakaian aplikasi ini legal bila mengikuti EULA dibawah<br />Silahkan beli hanya dari reseller kami</h1>
            </font>
          </center>
          ...
          <center>
            <font color="blue">
              <h1>End-User License Agreement (EULA) of INDOTORY<br />IDWARES Indonesia</h1>
            </font>
          </center>
          ...
          <left>
            <font color="black">
              <h3>
                ...
                <center>
                  <font color="blue"> You are permitted to:<br /><br /></font>
                </center>

                <center>Edit, modify, translate the script <font color="red"> for personal or educational use only </font>
                </center>
                <br /><br /><br />
                <center>
                  <font color="red">
                    <h1> You are NOT permitted to:</h1><br /><br />
                  </font>
                </center>
