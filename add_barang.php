   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
          ...
          if($chmod >= 3 || $_SESSION['jabatan'] == 'admin'){
                  $sql1 = "update $tabeldatabase set nama='$nama', hargabeli='$hargabeli', hargajual='$hargajual', kategori='$kategori', brand='$brand', keterangan='$keterangan' where kode='$kode'";
          ...
          echo "<script type='text/javascript'>window.location = '$forwardpage';</script>";
           ...
           $sql2 = "insert into $tabeldatabase values( '$kode','$nama','$hargabeli','$hargajual','$keterangan','$kategori','','','','','','$brand')";
