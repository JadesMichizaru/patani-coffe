            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
              ...
              if (mysqli_num_rows($result) > 0) {
                ...
                if ($trun9) {
                  ...
                  echo "<script type='text/javascript'>  alert('GAGAL, Data Aplikasi gagal di reser seluruhnya. Terjadi kesalahan dalam proses reset. Ulangi lagi dan pastikan internet anda stabil');</script>";
                }
              } else {
