      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-xs-12 col-sm 12 ">
          <div class="box box-solid box-success">
            <?php
            $barang       = mysqli_query($conn, "SELECT nama FROM barang WHERE sisa>'0' order by kode asc");
            ...
            <script>
              ...
              var myChart = new Chart(ctx, {
                type: 'bar',
                data: {
                  labels: [<?php while ($b = mysqli_fetch_array($barang)) {
                              echo '"' . $b['nama'] . '",';
                            } ?>],
                  datasets: [{
                    label: '# stok',
                    data: [<?php while ($p = mysqli_fetch_array($stok)) {
                              echo '"' . $p['sisa'] . '",';
                            } ?>],
                    backgroundColor: [
                      'rgba(255, 99, 132, 0.9)',
